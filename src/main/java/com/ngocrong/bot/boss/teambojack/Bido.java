...
public class Bido extends TeamBojack {

    private static final Logger logger = Logger.getLogger(Bido.class);

    private final GalaxySoldier team;

    public Bido(GalaxySoldier team) {
        super();
        this.team = team;
