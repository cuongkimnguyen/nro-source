...
public class Android13 extends Boss {
    ...
    private final static Logger logger = Logger.getLogger(Android13.class);

    private final TeamAndroid13 team;

    public Android13(TeamAndroid13 team) {
        super();
        this.team = team;
...
//        killer.isChangePoint = true;
        if (killer.taskMain != null && killer.taskMain.id == 23 && killer.taskMain.index == 3) {
